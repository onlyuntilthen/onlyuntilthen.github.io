...
<form id="fs-frm" name="simple-contact-form" accept-charset="utf-8" action="https://formspree.io/xknqyywa" method="post" style="text-align:center">
  <fieldset id="fs-frm-inputs">
    <br/><input type="text" name="name" id="full-name" placeholder="Name" required="" size="10">
    <br/><input type="email" name="_replyto" id="email-address" placeholder="Email" required="" size="10">
    <br/><textarea rows="5" name="message" id="message" placeholder="Message" required="" size="10" font="Helvetica Neue"></textarea>
